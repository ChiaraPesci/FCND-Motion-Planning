...
from planning_utils import a_star, heuristic, create_grid, prune_path, point, collinearity_check
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        # QUESTION: isn't it the grid corner??
        ...
        goal = (grid_start[0] + 10, grid_start[1] + 10, 0.0)
        goal = (213, 388, 0.0)
